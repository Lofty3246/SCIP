...
class Paras():
    def __init__(self):
        ...
        self.exp_output_path = "/home/lsy/Desktop/HUAWEI/EoH/examples/bp_online"  # default folder for ael outputs
        self.exp_use_seed = False
        self.exp_seed_path = "./seeds/seeds.json"
        self.exp_use_continue = True
        self.exp_continue_id = 0
        self.exp_continue_path = "/home/lsy/Desktop/HUAWEI/EoH/examples/bp_online/evaluation/trainingdata/gradient_score.json"
        self.exp_n_proc = 1
    ...
    def set_ec(self):    
        ...
        if self.management == None:
            if self.method in ['ael','eoh','eoh_cl']:
