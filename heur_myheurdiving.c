...
static SCIP_DECL_HEURCOPY(heurCopyMyheurdiving)
{ /*lint --e{715}*/
    assert(scip != NULL);
    assert(heur != NULL);
...
static SCIP_DECL_HEURFREE(heurFreeMyheurdiving) /*lint --e{715}*/
{                                               /*lint --e{715}*/
...
static SCIP_DECL_HEURINIT(heurInitMyheurdiving) /*lint --e{715}*/
{                                               /*lint --e{715}*/
    SCIP_HEURDATA *heurdata;
...
static SCIP_DECL_HEUREXIT(heurExitMyheurdiving) /*lint --e{715}*/
{                                               /*lint --e{715}*/
    SCIP_HEURDATA *heurdata;
...
static SCIP_DECL_HEUREXEC(heurExecMyheurdiving) /*lint --e{715}*/
{                                               /*lint --e{715}*/
    SCIP_HEURDATA *heurdata;
...
static SCIP_DECL_DIVESETGETSCORE(divesetGetScoreMyheurdiving)
{
        ...
        if (pFunc && PyCallable_Check(pFunc))
        {
            ...
            if (pValue != NULL)
            {
                ...
                if (pScore && pRoundup)
                {
                    ...
                    {
                        PyErr_Print();
                        fprint(stdeerr, "Python function returned invalid roundup value\n");
                    }
                    Py_DECREF(pValue);
                }
                else
